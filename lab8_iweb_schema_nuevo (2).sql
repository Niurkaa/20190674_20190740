...
ALTER TABLE `lab6sw1`.`cancion` 
ADD COLUMN `listaReproduccion_idlista` INT(11) NOT NULL AFTER `banda`,
ADD INDEX `fk_cancion_listaReproduccion1_idx` (`listaReproduccion_idlista` ASC) VISIBLE;
;
...
ALTER TABLE `lab6sw1`.`cancion` 
ADD CONSTRAINT `fk_cancion_listaReproduccion1`
  FOREIGN KEY (`listaReproduccion_idlista`)
  REFERENCES `lab6sw1`.`listaReproduccion` (`idlista`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
  
INSERT INTO `listaReproduccion` VALUES (1,'favorito');
